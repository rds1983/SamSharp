...
namespace SamSharp.Vidarh
{
	unsafe partial class Sam
	{
		...
		public static byte GetRuleByte(ushort mem62, byte Y)
		{
			uint address = (uint)(mem62);
			if ((mem62) >= (37541))
			{
				address -= (uint)(37541);
		...
		public static int handle_ch2(byte ch, byte mem)
		{
			byte tmp = 0;
			X = (byte)(mem);
			tmp = (byte)(tab36376[inputtemp[mem]]);
			if ((ch) == (' '))
			{
				if ((tmp & 128) != 0)
					return (int)(1);
		...
		public static int handle_ch(byte ch, byte mem)
		{
			byte tmp = 0;
			X = (byte)(mem);
			tmp = (byte)(tab36376[inputtemp[X]]);
			if ((ch) == (' '))
			{
				if ((tmp & 128) != 0)
					return (int)(1);
		...
		public static int TextToPhonemes(byte[] input)
		{
			...
			while ((X) < (255));
			inputtemp[255] = (byte)(27);
			mem56 = (byte)(mem61 = (byte)(255));
		pos36554:
			;
			while ((1) != 0)
			{
		...
		pos36700:
			;
			while ((GetRuleByte((ushort)(++mem62), (byte)(0)) & 128) == (0))
			{ }
			Y = (byte)(0);
			while (GetRuleByte((ushort)(mem62), (byte)(++Y)) != '(')
			{ }
			mem66 = (byte)(Y);
			while (GetRuleByte((ushort)(mem62), (byte)(++Y)) != ')')
			{ }
			mem65 = (byte)(Y);
			while ((GetRuleByte((ushort)(mem62), (byte)(++Y)) & 127) != '=')
			{ }
			mem64 = (byte)(Y);
			mem60 = (byte)(X = (byte)(mem61));
			Y = (byte)(mem66 + 1);
			while ((1) != 0)
			{
				if (GetRuleByte((ushort)(mem62), (byte)(Y)) != inputtemp[X])
					goto pos36700;
				if ((++Y) == (mem65))
					break;
				mem60 = (byte)(++X);
			...
			while ((1) != 0)
			{
				...
				{
					mem66--;
					mem57 = (byte)(GetRuleByte((ushort)(mem62), (byte)(mem66)));
					if ((mem57 & 128) != 0)
					{
						mem58 = (byte)(mem60);
						goto pos37184;
				...
				ch = (char)(mem57);
				r = (int)(handle_ch2((byte)(ch), (byte)(mem59 - 1)));
				if ((r) == (-1))
				{
					switch (ch)
					{
						case '&':
							if (Code37055((byte)(mem59 - 1), (byte)(16)) == 0)
							{
								if (inputtemp[X] != 'H')
									r = (int)(1);
								else
							...
							break;
						case '@':
							if (Code37055((byte)(mem59 - 1), (byte)(4)) == 0)
							{
								A = (byte)(inputtemp[X]);
								if (A != 72)
									r = (int)(1);
						...
						case '+':
							...
							break;
						case ':':
							while ((Code37055((byte)(mem59 - 1), (byte)(32))) != 0)
							{ --mem59; }
							continue;
						default:
							return (int)(0);
				...
				do
				{
					while ((1) != 0)
					{
						...
						if ((Y) == (mem64))
						{
							mem61 = (byte)(mem60);
							if ((debug) != 0)
								PrintRule((ushort)(mem62));
							while ((1) != 0)
							{
								mem57 = (byte)(A = (byte)(GetRuleByte((ushort)(mem62), (byte)(Y))));
								A = (byte)(A & 127);
								if (A != '=')
									input[++mem56] = (byte)(A);
								if ((mem57 & 128) != 0)
						...
						mem65 = (byte)(Y);
						mem57 = (byte)(GetRuleByte((ushort)(mem62), (byte)(Y)));
					...
					if ((r) == (0))
					{
						...
						if ((A) == ('@'))
						{
							if ((Code37055((byte)(mem58 + 1), (byte)(4))) == (0))
							{
								A = (byte)(inputtemp[X]);
						...
						{
							while ((Code37055((byte)(mem58 + 1), (byte)(32))) != 0)
							{ mem58 = (byte)(X); }
							r = (int)(-2);
						}
						else
							r = (int)(handle_ch((byte)(A), (byte)(mem58 + 1)));
					}
					if ((r) == (1))
						goto pos36700;
					if ((r) == (-2))
